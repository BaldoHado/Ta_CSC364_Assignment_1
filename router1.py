...
import os
import glob
from utils import create_socket, ip_to_bin, HOST, read_csv, find_default_gateway, generate_forwarding_table_with_range, write_to_file, process_packet
# Main Program
...
for packet in packets_table:
    ...
    process_packet(packet, default_gateway_port, forwarding_table_with_range,1, [("8002", "2"), ("8004", "4")])
